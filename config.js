...
module.exports = {
    ...
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'êª¶Í¢Ù­ð‘ºðœ£ð‘¼ð‘¹ð›¢ð‘½ð‘²ð‘³Â¹Â¹ê«‚;Raganork MD bot;https://i.imgur.com/P7ziVhr.jpeg' : process.env.AUDIO_DATA,
